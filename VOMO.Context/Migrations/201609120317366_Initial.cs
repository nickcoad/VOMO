    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Stub = c.String(nullable: false, maxLength: 50),
                        UpdatedAt = c.DateTime(nullable: false),
                        CreatedAt = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Attachment_Id, t.Post_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AttachmentPosts", "Post_Id", "dbo.Posts");
            DropForeignKey("dbo.AttachmentPosts", "Attachment_Id", "dbo.Attachments");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.TagPosts", new[] { "Post_Id" });
            DropIndex("dbo.TagPosts", new[] { "Tag_Id" });
            DropIndex("dbo.AttachmentPosts", new[] { "Post_Id" });
            DropIndex("dbo.AttachmentPosts", new[] { "Attachment_Id" });
